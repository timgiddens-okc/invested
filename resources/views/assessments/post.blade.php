					...
					<form action="" method="post">
						...
						<section>
							<div class="grid-x grid-padding-x">
								<div class="small-12 cell">
									<label>
										Which of the following is true about the risks and rewards associated with investing?<br>
										<input type="radio" name="q21" value="a" id="q21-a" required><label for="q21-a">Risky assets on average do not earn a risk premium</label><br>
										<input type="radio" name="q21" value="b" id="q21-b" required><label for="q21-b">There is usually a reward for bearing risk</label><br>
										<input type="radio" name="q21" value="c" id="q21-c" required><label for="q21-c">On average, the greater the risk, the lower the reward</label><br>
										<input type="radio" name="q21" value="d" id="q21-d" required><label for="q21-d">When comparing the common stock of two firms, the riskier one will have the lower price</label><br>
						...
						<section>
							<div class="grid-x grid-padding-x">
								<div class="small-12 cell">
									<label>
										Generally, the risk of an investment will ________ as the length of time ________.<br>
										<input type="radio" name="q22" value="a" id="q22-a" required><label for="q22-a">grow; decreases</label><br>
										<input type="radio" name="q22" value="b" id="q22-b" required><label for="q22-b">decrease; increases</label><br>
										<input type="radio" name="q22" value="c" id="q22-c" required><label for="q22-c">disappear; shortens</label><br>
										<input type="radio" name="q22" value="d" id="q22-d" required><label for="q22-d">lessen; shortens</label><br>
							...
							<div class="grid-x grid-padding-x">
								<div class="small-12 cell">
									<label>
										...
										<input type="radio" name="q23" value="a" id="q23-a" required><label for="q23-a">The stock market will go up</label><br>
										<input type="radio" name="q23" value="b" id="q23-b" required><label for="q23-b">The interest rates will go up</label><br>
										<input type="radio" name="q23" value="c" id="q23-c" required><label for="q23-c">The interest on her savings will compound</label><br>
										<input type="radio" name="q23" value="d" id="q23-d" required><label for="q23-d">Her savings will pay dividends</label><br>
										<input type="radio" name="q23" value="e" id="q23-e" required><label for="q23-e">I don't know.</label>
									</label>
								</div>
							</div>
						</section>
